...
krb5-multidev libapparmor1 libasan0 libasound2-data libxcb-xinerama0-dev \
...
./configure -confirm-license -opensource -nomake examples -nomake tests -force-debug-info -prefix /usr/local/qt5 && \
make && \
make install && \
cd qtwebengine && \
qmake && \
